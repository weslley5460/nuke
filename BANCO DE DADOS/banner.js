...
const banner2 = cfonts.render(('CRIADO POR: ZYX 07Hz and RUSSIN 07Hz'), {
font: 'console',
align: 'center',
gradrient: [`${cor4}`,`${cor2}`], 
...
const banner3 = cfonts.render((`NUKE`), {
font: 'slick',             
align: 'center',           
colors: [`${cor1}`],
...
const banner5 = cfonts.render(('ziquis'), {
font: 'console',
align: 'center',
gradrient: [`${cor4}`,], 
colors: [`${cor3}`],
...
authorname = 'NUKe CLiENT'
packname = 'ziquis'

const usedCommandRecently = new Set()

chyt = `5521999104979@s.whatsapp.net`
